...
export const ExecutiveTracks: React.FC = () => {
    ...
    const tracks: { title: string; description: string; color: "purple" | "orange" | "cyan" | "yellow" | "green" }[] = [
        ...
        },
        {
            ...
            description: "A personalized executive track tailored to role, experience, and strategic technology goals.",
            color: "green"
        }
    ];
        ...
        >
            ...
            <div className="space-y-4 relative z-20">
                <div className="inline-flex items-center gap-2">
                    <span className="text-[10px] font-black text-orange-500 uppercase tracking-[0.5em]">EXECUTIVE PATHWAYS</span>
                </div>
                <h2 className="text-4xl lg:text-5xl font-black text-gray-900 tracking-tighter">
                    Executive Track Options
                </h2>
                <p className="text-gray-500 font-medium tracking-tight text-lg max-w-3xl leading-relaxed">
