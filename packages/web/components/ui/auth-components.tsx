...
const AnimatedForm = memo(function AnimatedForm({
  ...
  const handleChange = (e: ChangeEvent<HTMLInputElement | HTMLSelectElement>, field: Field) => {
                ...
                <section className='relative'>
                  {field.type === 'text' && field.options ? (
                    <select
                      ...
                      className={cn(
                        `shadow-input dark:placeholder-text-neutral-600 flex h-10 w-full rounded-md border-none bg-gray-50 px-3 py-2 text-sm text-black transition duration-400 focus-visible:ring-[2px] focus-visible:ring-neutral-400 focus-visible:outline-none dark:bg-zinc-800 dark:text-white dark:shadow-[0px_0px_1px_1px_#404040] dark:focus-visible:ring-neutral-600`
                      )}
                    >
                    ...
                    <Input
                      ...
                      value={formData[field.name] || ''}
                      onChange={(e) => handleChange(e as ChangeEvent<HTMLInputElement>, field)}
                    />
                  )}
...
const AuthTabs = memo(function AuthTabs({
  ...
  return (
    <div className='flex max-lg:justify-center w-full min-h-screen bg-gray-50 dark:bg-zinc-900'>
      {/* Left Side Graphics */}
      <div className='hidden lg:flex w-1/2 items-center justify-center p-12 bg-white dark:bg-zinc-950'>
        {graphics}
      </div>

      {/* Right Side */}
      <div className='w-full lg:w-1/2 min-h-screen flex flex-col justify-center items-center px-[5%] lg:px-[10%] bg-gray-50 dark:bg-zinc-900'>
        <AnimatedForm
          {...formFields}
          fieldPerRow={1}
